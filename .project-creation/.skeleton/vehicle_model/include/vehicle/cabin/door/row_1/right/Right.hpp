#ifndef VEHICLE_CABIN_DOOR_ROW_1_RIGHT_RIGHT_H
#define VEHICLE_CABIN_DOOR_ROW_1_RIGHT_RIGHT_H

#include "sdk/DataPoint.h"
#include "sdk/Model.h"

#include "vehicle/cabin/door/row_1/right/shade/Shade.hpp"
#include "vehicle/cabin/door/row_1/right/window/Window.hpp"

#include <string>

namespace vehicle::cabin::door::row_1::right {
...
public:
    ...
    *
    **/
    vehicle::cabin::door::row_1::right::shade::Shade Shade;
    ...
    *
    **/
    vehicle::cabin::door::row_1::right::window::Window Window;

};

} // namespace vehicle::cabin::door::row_1::right

#endif // VEHICLE_CABIN_DOOR_ROW_1_RIGHT_RIGHT_H
