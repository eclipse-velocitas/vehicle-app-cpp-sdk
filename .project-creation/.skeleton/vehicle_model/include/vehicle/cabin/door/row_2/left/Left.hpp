#ifndef VEHICLE_CABIN_DOOR_ROW_2_LEFT_LEFT_H
#define VEHICLE_CABIN_DOOR_ROW_2_LEFT_LEFT_H

#include "sdk/DataPoint.h"
#include "sdk/Model.h"

#include "vehicle/cabin/door/row_2/left/shade/Shade.hpp"
#include "vehicle/cabin/door/row_2/left/window/Window.hpp"

#include <string>

namespace vehicle::cabin::door::row_2::left {
...
public:
    ...
    *
    **/
    vehicle::cabin::door::row_2::left::shade::Shade Shade;
    ...
    *
    **/
    vehicle::cabin::door::row_2::left::window::Window Window;

};

} // namespace vehicle::cabin::door::row_2::left

#endif // VEHICLE_CABIN_DOOR_ROW_2_LEFT_LEFT_H
