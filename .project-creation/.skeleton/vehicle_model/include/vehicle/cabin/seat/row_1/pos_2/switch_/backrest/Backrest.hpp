#ifndef VEHICLE_CABIN_SEAT_ROW_1_POS_2_SWITCH__BACKREST_BACKREST_H
#define VEHICLE_CABIN_SEAT_ROW_1_POS_2_SWITCH__BACKREST_BACKREST_H

#include "sdk/DataPoint.h"
#include "sdk/Model.h"

#include "vehicle/cabin/seat/row_1/pos_2/switch_/backrest/lumbar/Lumbar.hpp"
#include "vehicle/cabin/seat/row_1/pos_2/switch_/backrest/side_bolster/SideBolster.hpp"

#include <string>

namespace vehicle::cabin::seat::row_1::pos_2::switch_::backrest {
...
public:
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_2::switch_::backrest::lumbar::Lumbar Lumbar;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_2::switch_::backrest::side_bolster::SideBolster SideBolster;

};

} // namespace vehicle::cabin::seat::row_1::pos_2::switch_::backrest

#endif // VEHICLE_CABIN_SEAT_ROW_1_POS_2_SWITCH__BACKREST_BACKREST_H
