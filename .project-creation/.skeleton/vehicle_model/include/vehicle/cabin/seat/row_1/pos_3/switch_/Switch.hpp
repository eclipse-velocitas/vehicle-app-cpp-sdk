#ifndef VEHICLE_CABIN_SEAT_ROW_1_POS_3_SWITCH__SWITCH_H
#define VEHICLE_CABIN_SEAT_ROW_1_POS_3_SWITCH__SWITCH_H

#include "sdk/DataPoint.h"
#include "sdk/Model.h"

#include "vehicle/cabin/seat/row_1/pos_3/switch_/backrest/Backrest.hpp"
#include "vehicle/cabin/seat/row_1/pos_3/switch_/headrest/Headrest.hpp"
#include "vehicle/cabin/seat/row_1/pos_3/switch_/massage/Massage.hpp"
#include "vehicle/cabin/seat/row_1/pos_3/switch_/seating/Seating.hpp"

#include <string>

namespace vehicle::cabin::seat::row_1::pos_3::switch_ {
...
public:
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_3::switch_::backrest::Backrest Backrest;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_3::switch_::headrest::Headrest Headrest;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_3::switch_::massage::Massage Massage;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_3::switch_::seating::Seating Seating;

};

} // namespace vehicle::cabin::seat::row_1::pos_3::switch_

#endif // VEHICLE_CABIN_SEAT_ROW_1_POS_3_SWITCH__SWITCH_H
