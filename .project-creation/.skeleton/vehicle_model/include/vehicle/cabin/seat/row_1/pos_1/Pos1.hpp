#ifndef VEHICLE_CABIN_SEAT_ROW_1_POS_1_POS1_H
#define VEHICLE_CABIN_SEAT_ROW_1_POS_1_POS1_H

#include "sdk/DataPoint.h"
#include "sdk/Model.h"

#include "vehicle/cabin/seat/row_1/pos_1/airbag/Airbag.hpp"
#include "vehicle/cabin/seat/row_1/pos_1/backrest/Backrest.hpp"
#include "vehicle/cabin/seat/row_1/pos_1/headrest/Headrest.hpp"
#include "vehicle/cabin/seat/row_1/pos_1/occupant/Occupant.hpp"
#include "vehicle/cabin/seat/row_1/pos_1/seating/Seating.hpp"
#include "vehicle/cabin/seat/row_1/pos_1/switch_/Switch.hpp"

#include <string>

namespace vehicle::cabin::seat::row_1::pos_1 {
using ParentClass = velocitas::Model;

/** Pos1 model. */
class Pos1 : public ParentClass {
public:

    Pos1(const std::string& name, ParentClass* parent) :
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_1::airbag::Airbag Airbag;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_1::backrest::Backrest Backrest;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_1::headrest::Headrest Headrest;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_1::occupant::Occupant Occupant;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_1::seating::Seating Seating;
    ...
    *
    **/
    vehicle::cabin::seat::row_1::pos_1::switch_::Switch Switch;
...
#endif // VEHICLE_CABIN_SEAT_ROW_1_POS_1_POS1_H
