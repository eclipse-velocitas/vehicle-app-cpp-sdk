#ifndef VEHICLE_BODY_WINDSHIELD_FRONT_WIPING_SYSTEM_SYSTEM_H
#define VEHICLE_BODY_WINDSHIELD_FRONT_WIPING_SYSTEM_SYSTEM_H
...
namespace vehicle::body::windshield::front::wiping::system {
...
#endif // VEHICLE_BODY_WINDSHIELD_FRONT_WIPING_SYSTEM_SYSTEM_H
