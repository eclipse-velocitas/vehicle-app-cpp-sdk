...
class VehicleAppCppSdkConan(ConanFile):
    ...
    requires = "nlohmann_json/3.11.2", "paho-mqtt-cpp/1.2.0", "grpc/1.50.1@#df352027120f88bccf24cbc40a2297ce", "protobuf/3.21.9", "cpr/1.9.3", "fmt/9.1.0", "googleapis/cci.20221108@#e4bebdfa02f3b6f93bae1d5001b8d439", "paho-mqtt-c/1.3.9@#0421671a9f4e8ccfa5fc678cfb160394"
    generators = "cmake"
